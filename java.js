...
// KHU VỰC SYSTEM;
// function gotostore(){
//         button1.innerText="Buy 10 healdth(10 gold)";
//         button2.innerText="Buy weapon(30 gold)";
//         button3.innerText="Go to town spuare";
//         text.innerText="You can buy items in here";
// }
// function gotocave(){
//     button1.innerText="fight smile";
//     button2.innerText="Teleport for attack monster";
//     button3.innerText="Run"
//     text.innerText="You meet some monster in the cave"
// }
// function fighttingdragon(){
...
function attack(){
    ...
    hp2=monster[fighting2].hp-dameinms;
    ...
    if(hp2<=0)
    {
        ...
        console.log(monster2[fighting2].hp)
        goback();
    }
    if(health<=0)
    {
        ...
        healthtext.innerText=health;
        headthmonster.innerText=hp2;
        monster[fighting2].hp=hp2;
